...
function Dashboard() {
    ...
    return (
        ...
        <div className="app-container"> {/* This class should make the div use the full page */}
        <Navbar />
      ...
      <div className="back-arrow-container">    
        ...
        <main className="dashboard-content">
            ...
            <div className="user-info-section">
                ...
                <button className="btn-change-photo" onClick={triggerFileInput}>Change profile photo</button>
                <input type="file" id="profilePhotoInput" style={{ display: 'none' }} onChange={handlePhotoChange} />
            </div>
    </div>
