...
<body>
  ...
  <div class="about-main">
    ...
    <div class="container">
      ...
      <h2 class="alumni-sans">About Us</h2>
      ...
      <div class="about-story">
        <h3 class="alumni-sans">Our Story</h3>
        ...
        <h3 class="alumni-sans">Meet the Team</h3>
        <p>Our team is made up of a diverse group of individuals united by a common goal: 
            ...
            <div class="team-members">
                ...
                <h4 class="alumni-sans">Member Name</h4>
                <p>Title</p>
                <p>Short bio...</p>
            </div>
            <div class="team-member">
      ...
      <div class="about-values">
        <h3 class="alumni-sans">Our Values</h3>
        <ul>
